...
1.  This **QUESTION PAPER** contains **25** Questions in **10**
    Sections, and comprises **18** printed pages, including this page.
...
> eval_stream(strm, 10);
  ...
  **F.**   list(1, 2, 5, 4, 10, 8, 20, 16, 40, 32)
...
+--------+---------------------------+---------------------+-----------------------------------+
| **A.** | 1 2 3 3 3 3               | **E.**              | 1 2 3 3 1 2 3 1 2 3 1             |
+========+===========================+=====================+===================================+
| **B.** | 1 2 3 3                   | **F.**              | 1 2 3                             |
+--------+---------------------------+---------------------+-----------------------------------+
| **C.** | 1 2 3 3 1                 | **G.**              | 1 2 3 1 2 3                       |
+--------+---------------------------+---------------------+-----------------------------------+
| **D.** | 1 2 3 3 1 2 3 3           |                                                         |
+--------+---------------------------+---------------------------------------------------------+
...
f(2)(3);
  ...
  **D.**   7                              **H.**   none of the other options
  ---------------------------------------------------------------------------------
...
generated](media/image1.png){width="4.524752843394576in"
